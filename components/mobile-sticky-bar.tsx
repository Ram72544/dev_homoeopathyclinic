...
export function MobileStickyBar() {
  ...
  const orbClasses =
    "flex h-13 w-13 items-center justify-center rounded-full bg-white text-[#0E7C7B] border border-[#E8E1D5] shadow-xs transition-all duration-200 hover:border-[#0E7C7B] hover:bg-[#FAF8F5] hover:shadow-sm active:scale-90 cursor-pointer";
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto rounded-full border border-white/95 bg-white/85 p-2.5 shadow-[0_20px_50px_-10px_rgba(20,34,27,0.16),0_1px_2px_rgba(255,255,255,0.95)_inset] backdrop-blur-2xl flex items-center gap-4 sm:gap-5">
