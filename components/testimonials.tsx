              ...
              {site.testimonials.map((t, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <Quote
                        className="pointer-events-none absolute -right-2 -top-2 h-20 w-20 text-[#C5A059]/10 dark:text-[#E5C583]/10"
                        strokeWidth={1}
                      />
                      <div>
                        ...
                        <blockquote className="relative mt-3.5 text-sm sm:text-base font-light leading-relaxed text-[#14221B] dark:text-[#FAF8F5]">
                          &ldquo;{t.quote}&rdquo;
                        </blockquote>
                      </div>

                      <figcaption className="relative mt-5 sm:mt-7 flex items-center gap-3.5 border-t border-[#EAE3DA] dark:border-white/10 pt-3.5">
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            <p className="font-serif text-sm sm:text-base font-normal text-[#14221B] dark:text-[#FAF8F5]">
                              {t.name}
                            </p>
                            <BadgeCheck
                              className="h-4 w-4 text-[#0E7C7B] dark:text-[#14B8A6]"
                              aria-label="Verified patient"
                            />
                          </div>
                          <p className="text-[11px] sm:text-xs font-light text-[#7A8A80] dark:text-[#9EB3A8]">
